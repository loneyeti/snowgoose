      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            title="Add Persona"
            className={`p-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-600 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors ${disableSelection ? "opacity-75 cursor-not-allowed" : ""}`}
            disabled={disableSelection}
